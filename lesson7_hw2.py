...
class Clothes(ABC):
    ...
    def my_method_1(self):
        print("Type of clothing:", end=' ')

    @abstractmethod
    def my_method_2(self):
        print("Parameters of clothing:", end=' ')

    @abstractmethod
    def my_method_3(self):
        print("Fabric consumption :", end=' ')
...
size_coat = int(input('\nEnter size of coat: '))
size_suit = int(input('Enter high for suit: '))
...
print("\nTotal fabric consumption: %.2f" % t.sum())